...
@endsection
@section('content')
	<form action="{{route('bienes_unidades.store')}}" class="form-horizontal" method="POST">
		{{csrf_field()}}
		<div class="form-group">
			<label for="" class="control-label col-md-2">Identificación</label>
			<div class="col-md-4">
				<input type="text" id="identificacion" name="identificacion" class="form-control" required="" value="">
			</div>
			<label for="" class="control-label col-md-2">Actividad</label>
			<div class="col-md-4">
				<input type="text" id="actividad" name="actividad" class="form-control" required value="">
			</div>
		</div>
		<div class="form-group">
			<label for="" class="control-label col-md-2">Ubicación</label>
			<div class="col-md-4">
				<textarea name="ubicacion" id="ubicacion" rows="2" class="form-control" required></textarea>
			</div>
		</div>
		<div class="form-group">
