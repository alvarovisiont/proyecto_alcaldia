...
@section('view_descrip')
		<h3 class="text-center">Reporte Libro Mayor</h3>
@endsection

@section('content')
	<form action="{{ url('/cont_libro_mayor_pdf') }}" class="form-horizontal"  id="form_pdf">
		<div class="form-group">
			<label for="" class="col-md-2 col-md-offset-2">Desde</label>
			<div class="col-md-4">
