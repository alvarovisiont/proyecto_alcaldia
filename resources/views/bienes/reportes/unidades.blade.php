...
@section('content')
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('bienes_reportes.unidades')}}" class="form-horizontal" method="POST">
				{{csrf_field()}}
				<h2 class="text-center"><span class="subrayado_rojo">Reporte de Unidades</span></h2>
				<br>
