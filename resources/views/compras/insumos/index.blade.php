		...
		<tbody class="text-center">
			...
			@foreach($insumos as $in)
				<tr>
					...
					<td>
					  <a href="{{ url('roles/'.$in->id_rol) }}" class="btn btn-flat btn-success btn-sm"><i class="fa fa-search"></i></a>
						<a href="{{ url('roles/'.$in->id_rol.'/edit') }}" class="btn btn-flat btn-warning btn-sm" title="Editar"><i class="fa fa-edit"></i></a>
					</td>
				</tr>
				@php $i++; @endphp
			@endforeach
